...
import ai.openclaw.app.picoclaw.PcChatMessage
import ai.openclaw.app.picoclaw.PcImageAttachment
import ai.openclaw.app.picoclaw.PcMode
import ai.openclaw.app.picoclaw.PcState
import ai.openclaw.app.picoclaw.PicoClawViewModel
import ai.openclaw.app.ui.chat.PendingImageAttachment
import ai.openclaw.app.ui.chat.loadSizedImageAttachment
    ...
    Column(
        ...
        if (isIdle) {
            ...
            OutlinedButton(
                onClick = {
                    ...
                    GmsBarcodeScanning.getClient(
                        ...
                        .addOnFailureListener { e ->
                            qrScanError = e.localizedMessage ?: "Scan failed"
                        }
                },
                ...
                Text(text = "Scan QR Code", style = mobileCallout.copy(fontWeight = FontWeight.Bold))
            }
        ...
        if (state == PcState.FetchingToken || state == PcState.Connecting) {
            val msg = if (state == PcState.FetchingToken) "Fetching token from gateway..." else "Opening WebSocket..."
            Row(
